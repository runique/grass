...
<link rel="stylesheet" href="./HTML_Templates_files/W3C-WG-NOTE" type="text/css">
</head>
...
<div class="logo">
    <a href="http://www.w3.org/"><img width="72" height="48" src="./HTML Templates_files/w3c_home" alt="W3C"></a>
</div>
...
previously specified in this document are now specified in <a href="http://www.w3.org/TR/html5/scripting-1.html#the-template-element">HTML5</a>.
</strong></p>
